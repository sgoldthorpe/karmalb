...
my $path_to_files = "/opt/klb/backups";

# The path to the error log file
my $error_log = '/opt/klb/logs/downloads.txt';
...
# Parse the "filename" paramater sent to the script.
my $file = $IN{ 'filename' } or error( 'No file selected.' );
