...
if ( -e "/opt/klb/www/networking_functions_ext.cgi" )
{
	require "/opt/klb/www/networking_functions_ext.cgi";
	$ext = 1;
}
...
sub delIf($if)
{
	...
	# delete graphs
	unlink ( "/opt/klb/www/img/graphs/${if}\_d.png" );
	unlink ( "/opt/klb/www/img/graphs/${if}\_m.png" );
	unlink ( "/opt/klb/www/img/graphs/${if}\_w.png" );
	unlink ( "/opt/klb/www/img/graphs/${if}\_y.png" );
	unlink ( "/opt/klb/app/zenrrd/rrd/${if}iface.rrd" );
	return $status;
}
